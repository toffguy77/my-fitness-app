...
if (typeof window !== 'undefined') {
    try {
        ...
        // Молчим намеренно: это уборка старого кеша при старте, до любого
        // экрана и до любого действия человека. Приватный просмотр отказывает
        // в хранилище — тогда кеша просто нет, и дневник работает по сети.
