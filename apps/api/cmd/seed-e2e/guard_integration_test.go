...
//
// 2026-09-13 фикстуры уехали на прод: пять учёток, включая одну с ролью
// super_admin, с паролем, посчитанным `bcrypt.MinCost` — стоимостью 4 вместо
// 10. Для тестов это правильно, иначе прогон тратит секунды на хэширование. На
// боевой базе это учётная запись с полными правами и намеренно ослабленным
// паролем.
//
