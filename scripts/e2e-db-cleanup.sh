...
# ---------------------------
# 1. Три учётные записи прогона (адреса из слепка) — целиком, вместе со всем,
#    что на них ссылается: дневник, заявки, разговоры, назначения куратора,
#    сессии, ссылки для входа, выгрузки.
#
