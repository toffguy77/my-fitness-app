...
export function validateDailyTotals(
  ...
  if (calories < 1000) {
    ...
    warnings.push('Дневная норма калорий очень высокая (>5000 ккал). Проверьте правильность расчета или проконсультируйтесь с координатором.')
  }
  ...
  if (protein < 20) {
    ...
    warnings.push('Дневная норма белков очень высокая (>300 г). Проверьте правильность расчета или проконсультируйтесь с координатором.')
  }
  ...
  if (fats < 20) {
    ...
    warnings.push('Дневная норма жиров очень высокая (>150 г). Проверьте правильность расчета или проконсультируйтесь с координатором.')
  }
  ...
  if (carbs < 20) {
    ...
    warnings.push('Дневная норма углеводов очень высокая (>400 г). Проверьте правильность расчета или проконсультируйтесь с координатором.')
  }
...
/**
 * Валидация nutrition_targets для координатора (используется в Server Actions)
 */
