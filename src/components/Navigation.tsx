...
export default function Navigation() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-zinc-900 z-50 safe-area-inset-bottom">
        ...
        {!loading && navigationItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center gap-1 flex-1 h-full transition-colors ${isActive ? 'text-zinc-100' : 'text-zinc-500'
                }`}
            >
              <Icon size={22} />
