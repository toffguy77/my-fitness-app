...
COMMENT ON COLUMN daily_logs.meals IS 'Массив приемов пищи за день. Формат: [{"id": "uuid", "title": "string", "weight": number, "per100": {"calories": number, "protein": number, "fats": number, "carbs": number}, "totals": {"calories": number, "protein": number, "fats": number, "carbs": number}, "mealDate": "YYYY-MM-DD", "createdAt": "timestamp"}]';
...
-- 6.1.1 Функции для работы со структурой meals (per100 и totals)
...
-- Триггер для автоматической синхронизации meals
