...
#### 3.3 Виджет заметки куратора (Premium)
- Отображение заметки от куратора за выбранную дату
...
- Уведомление куратора (для Premium)
...
#### 6.4 Информация о кураторе (Premium)
- Имя куратора
- Email куратора
- Ссылка на чат с куратором
...
### 7. Чат с куратором (Premium)

**Описание:** Real-time чат между клиентом и куратором
...
```
Как Premium клиент
Я хочу общаться с куратором в реальном времени
...
## Функции для кураторов (Curator)

### 1. Кабинет куратора

**Описание:** Главная страница куратора со списком клиентов
...
#### 1.1 Список клиентов
- Отображение всех Premium клиентов куратора
...
- Клик по клиенту → `/app/curator/[clientId]`
...
**Описание:** Просмотр данных клиента куратором

**Маршрут:** `/app/curator/[clientId]`
...
#### 2.3 Заметки куратора
- Date Picker для выбора даты
- Текстовое поле для ввода заметки
- Сохранение заметки в `curator_notes`
- Оптимистичные обновления UI
